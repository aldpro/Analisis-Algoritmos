...
public class MultiplicacionRusa {
    ...
    public static void main(String[] args) {
        ...
        int resultado = multiplicarRusa(multiplicador,multiplicando,numerosMultiplicador, numerosMultiplicando, almacenador);



        for(int i=0;i<numerosMultiplicador.length;i++) {
            System.out.println("Numero1: :" + numerosMultiplicador[i] + "  |    "
                    + " Numero2: " + numerosMultiplicando[i] + "|    " + " Acumulado: " + almacenador[i]+"|");
        }
