...
// Esta implementación es dinámica porque el tamaño del arreglo resultante no
// está predeterminado, sino que
// se adapta dinámicamente al tamaño de los números que se están multiplicando.
// En otras palabras,
// no es necesario saber de antemano el tamaño máximo del resultado, sino que se
// crea un arreglo del
// tamaño adecuado una vez que se ha realizado la multiplicación. Además, se
// utiliza una lista dinámica
// (ArrayList) en lugar de un arreglo estático para almacenar temporalmente los
// resultados parciales de
// la multiplicación, lo que permite agregar elementos dinámicamente según sea
// necesario.
